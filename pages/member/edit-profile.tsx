...
import { FormItems } from '../../components/molecules/FormItems/FormItems'
import { updateProfileFormItems as formItems } from '../../constants/constants'
							...
							<div className="photo d-flex">
								<div className="position-relative me-20">
									...
									<div
										...
										<Image src="/icon/delete.svg" width={24} height={24}/>
									</div>
								</div>
