							...
							<div
								...
								<div className="categories-card">
									<div
										...
										<p
											className="color-palette-1 mb-0 ms-12">Game<br/> Desktop
										</p>
									</div>
									<div>
										<p
											className="text-sm color-palette-2 mb-1">Total
											Spent</p>
										<p
											className="text-2xl color-palette-1 fw-medium m-0">Rp
											18.000.500</p>
									</div>
								</div>
							</div>
							<div
								...
								<div className="categories-card">
									<div
										...
										<p
											className="color-palette-1 mb-0 ms-12">Game<br/> Mobile
										</p>
									</div>
									<div>
										<p
							...
							<div
								...
								<div className="categories-card">
									<div
										...
										<p
											className="color-palette-1 mb-0 ms-12">Other<br/> Categories
										</p>
									</div>
									<div>
										<p
					...
					<div
						...
						<table className="table table-borderless">
							...
							<tr className="color-palette-1">
								<th className="text-start" scope="col">Game
								</th>
							...
							<tr className="align-middle">
								<th scope="row">
									...
									<div className="game-title-header">
										<p
											className="game-title fw-medium text-start color-palette-1 m-0">Mobile
											Legends:
											The New
											Battle 2021</p>
										<p
											className="text-xs fw-normal text-start color-palette-2 m-0">Desktop</p>
									</div>
								</th>
								<td>
									<p
										className="fw-medium color-palette-1 m-0">200
										Gold</p>
								</td>
								<td>
									<p
										className="fw-medium text-start color-palette-1 m-0">Rp
										290.000</p>
								</td>
								<td>
									<div>
										<span
											className="float-start icon-status pending"></span>
										<p
							...
							<tr className="align-middle text-center">
								<th scope="row">
									...
									<div className="game-title-header">
										<p
											className="game-title fw-medium text-start color-palette-1 m-0">Call
											of
											Duty:Modern</p>
										<p
											className="text-xs fw-normal text-start color-palette-2 m-0">Desktop</p>
								...
								<td>
									<p
										className="fw-medium text-start color-palette-1 m-0">550
										Gold</p>
								</td>
								<td>
									<p
								...
								<td>
									<div>
                                          <span
																						className="float-start icon-status success"></span>
										<p
											className="fw-medium text-start color-palette-1 m-0 position-relative">
											Success</p>
									</div>
							...
							<tr className="align-middle text-center">
								<th scope="row">
									...
									<div className="game-title-header">
										<p
											className="game-title fw-medium text-start color-palette-1 m-0">Clash
											of
											Clans</p>
										<p
											className="text-xs fw-normal text-start color-palette-2 m-0">Mobile</p>
									</div>
								</th>
								<td>
									<p
										className="fw-medium text-start color-palette-1 m-0">100
										Gold</p>
								</td>
								<td>
									<p
								...
								<td>
									<div>
										<span
											className="float-start icon-status failed"></span>
										<p
											className="fw-medium text-start color-palette-1 m-0 position-relative">Failed
										</p>
									</div>
								</td>
							</tr>
							<tr className="align-middle text-center">
								<th scope="row">
									...
									<div className="game-title-header">
										<p
											className="game-title fw-medium text-start color-palette-1 m-0">The
											Royal
											Game</p>
										<p
											className="text-xs fw-normal text-start color-palette-2 m-0">Mobile</p>
								...
								<td>
									<p
										className="fw-medium text-start color-palette-1 m-0">225
										Gold</p>
								</td>
								<td>
									<p
